...
export default function PlayerCard({player}) {
  ...
  return (
    <div onClick={() => navigate(`/player/${player.id}`)} key={player.id} className="player">
          <img style={player.league === "LIV" ? {width: "70px"} : null}className="player-league" src={player.league === "PGA" ? "../../../public/images/pga.png" : "../../../public/images/liv.png"}></img>
          ...
          <div className="bottom">
            ...
            <img className="player-nation-img" src={`../../../public/images/flags/${countryCodes[player.nation]}.svg`}></img>
